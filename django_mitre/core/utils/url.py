...
def get_view_name(m: Model, v: str):
...
def produce_paths_for_model(
    ...
    index_view_class = getattr(views, get_view_name(model, "index"), None)
    ...
    detail_view = getattr(views, get_view_name(model, "detail")).as_view()
