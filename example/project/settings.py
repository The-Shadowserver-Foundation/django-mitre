...
SECRET_KEY = 'django-insecure-)9l69ik=g21v76$9!)z@t1s4abv_@!hen@a#rdf6gz+v4##g3)'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            "builtins": [
                # Adds the `querystring` template tag to built-ins,
                # so that it does not need loaded to be used in templates;
